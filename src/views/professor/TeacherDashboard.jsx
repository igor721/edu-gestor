...
export const TeacherDashboard = ({ user, stats, colors }) => (
  <div className="space-y-6">
    <header>
      <h2 className="text-2xl font-bold text-gray-800">Painel Pedagógico</h2>
      <p className="text-gray-500">Prof. {user.name}, veja o panorama das suas turmas.</p>
    </header>
        ...
        <div className="h-64">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={stats.performanceData}>
              ...
              <XAxis dataKey="turma" />
              {/* AJUSTE AQUI: O domínio agora é de 0 a 10 */}
